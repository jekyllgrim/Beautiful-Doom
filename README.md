...
***Beautiful Doom's code is licensed under GPLv3. Permissions for assets may vary. If you want to use Beautiful Doom in your work, please obtain a permission from <u>the author</u>. See more details [below](#Use-of-resources-and-permissions).***
...
5. If you're getting errors, make sure you have the up-to-date version of [GZDoom](https://zdoom.org/downloads).
